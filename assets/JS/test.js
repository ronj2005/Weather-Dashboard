...
// This function displays the city entered
...
async function displayWeather() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=152ae2b8b820db732e591a903f32c1ef";
    ...
    var response = await $.ajax({
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=152ae2b8b820db732e591a903f32c1ef="+getLat+"&lon="+getLong;
...
async function displayFiveDayForecast() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+cityname+"&units=imperial&appid=152ae2b8b820db732e591a903f32c1ef";
...
// This function is used to pass the city in the history list 
